    ...
    <v-row justify="center" class="mb-4">
        <v-col cols="12">
            <v-card class="p-3">
                ...
                <v-data-table :footer-props="tableFooterPros" :headers="headers" :items="$store.state.clientes.listagem"
                    :search="search" dense mobile-breakpoint="400">
        ...
        <clientesCadastro v-if="exibCadastro" :open="exibCadastro" @close="exibCadastro = false" @cancelar="cancelar"
